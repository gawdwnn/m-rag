...
>(({ className, ...props }, ref) => (
  <thead
    ref={ref}
    className={cn(
      '[&_tr]:border-b-0.5 sticky top-0 z-10 bg-bg-title',
      className,
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  <th
    ref={ref}
    className={cn(
      'h-14 px-4 text-left align-middle font-normal text-text-secondary first-of-type:pl-6 last-of-type:pr-6 [&:has([role=checkbox])]:pr-0',
      className,
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  <td
    ref={ref}
    className={cn(
      'px-4 py-3 align-middle font-normal text-text-primary first-of-type:pl-6 last-of-type:pr-6 [&:has([role=checkbox])]:pr-0',
      className,
    )}
    {...props}
  />
